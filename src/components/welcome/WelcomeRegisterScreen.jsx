...
function WelcomeRegisterScreen({
  isOpen,
  onBack,
  onOpenLogin,
  onSubmit,
    ...
    <div className="absolute inset-0 z-30 flex h-full flex-col bg-[#09090E]">
      ...
      <div className="flex h-full flex-col bg-[#09090E]">
        <div className="flex shrink-0 items-center gap-3 px-5 pt-4 pb-4">
          ...
          <h1 className="text-xl font-bold text-white">{lt("Создать аккаунт", "Konto erstellen")}</h1>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-8">
          ...
          >
            <div className="mb-2">
              <h2 className="mb-2 text-2xl font-bold text-white">{lt("Добро пожаловать в TOP.DANCE", "Willkommen bei TOP.DANCE")}</h2>
            </div>
            ...
            >
              <CheckIcon />
              {isSubmitting
                ? lt("Создаём аккаунт...", "Konto wird erstellt...")
            ...
            <div className="mt-2 text-center">
              <span className="text-sm text-white/45">{lt("Уже есть аккаунт? ", "Hast du schon ein Konto? ")}</span>
              <button
                type="button"
                onClick={onOpenLogin}
...
export default WelcomeRegisterScreen;
